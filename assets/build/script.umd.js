...
;// CONCATENATED MODULE: ./assets/js/components/fetchData.js
...
;// CONCATENATED MODULE: ./assets/js/components/scroll.js
...
var scrollToId = function scrollToId() {
  $("a[href^='#']:not([href='#'])").click(function (e) {
    ...
    var hash = this.hash;
    var section = $(hash);
    var $header = $('.mainHeader'); // Le header
...
/******/ 	__webpack_require__.O(undefined, [720], () => (__webpack_require__(912)))
